...
Device::BuiltinAction start_recovery(Device* device, const std::vector<std::string>& args) {
  ...
  // Nyanpasu_VERSION_APPEND_TIME_OF_DAY is set to true has the desired date.
  std::string ver = android::base::GetProperty("ro.nyanpasu.version", "");
  ...
  std::vector<std::string> title_lines = {
    "Version " + android::base::GetProperty("ro.nyanpasu.version", "(unknown)") +
        " (" + ver_date + ")",
  };
  title_lines.insert(std::begin(title_lines), "Nyanpasu Recovery");
